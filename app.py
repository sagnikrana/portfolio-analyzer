...
- Dimension score: `{dimension_scores["concentration_risk"]}/100` ({score_readout(dimension_scores["concentration_risk"])})
...
### 2. Behavioral Risk
- Dimension score: `{dimension_scores["behavioral_risk"]}/100` ({score_readout(dimension_scores["behavioral_risk"])})
...
### 3. Market Risk
- Dimension score: `{dimension_scores["market_risk"]}/100` ({score_readout(dimension_scores["market_risk"])})
